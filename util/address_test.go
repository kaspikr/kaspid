...
func TestParsePrefix(t *testing.T) {
	tests := []struct {
		...
		{"kaspi", util.Bech32PrefixKaspa, false},
		{"kaspitest", util.Bech32PrefixKaspaTest, false},
		{"kaspisim", util.Bech32PrefixKaspaSim, false},
...
func TestPrefixToString(t *testing.T) {
	tests := []struct {
		...
		{util.Bech32PrefixKaspa, "kaspi"},
		{util.Bech32PrefixKaspaTest, "kaspitest"},
		{util.Bech32PrefixKaspaSim, "kaspisim"},
		{util.Bech32PrefixUnknown, ""},
	}
