...
func TestAddresses(t *testing.T) {
	tests := []struct {
		...
		{
			name:    "mainnet p2pk",
			addr:    "kaspi:qq8n68rmnqqn7urgrepgw5285cmv4lm723qr8aywe0xcs4dmk8npga258xkvm",
			encoded: "kaspi:qq8n68rmnqqn7urgrepgw5285cmv4lm723qr8aywe0xcs4dmk8npga258xkvm",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixKaspi,
				[util.PublicKeySize]byte{
					0x0f, 0x3d, 0x1c, 0x7b, 0x98, 0x01, 0x3f, 0x70, 0x68, 0x1e,
					0x42, 0x87, 0x51, 0x47, 0xa6, 0x36, 0xca, 0xff, 0x7e, 0x54,
					0x40, 0x33, 0xf4, 0x8e, 0xcb, 0xcd, 0x88, 0x55, 0xbb, 0xb1,
					0xe6, 0x14,
				}),
			f: func() (util.Address, error) {
				publicKey := []byte{
					...
					0x40, 0x33, 0xf4, 0x8e, 0xcb, 0xcd, 0x88, 0x55, 0xbb, 0xb1,
					0xe6, 0x14}
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixKaspi)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixKaspi,
		},
		/*
			{
				name:    "mainnet p2pk 2",
				addr:    "kaspi:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cvfqgz3z8",
				encoded: "kaspi:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cvfqgz3z8",
				valid:   true,
				result: util.TstAddressPubKey(
					util.Bech32PrefixKaspi,
					[util.PublicKeySize]byte{
				...
				passedPrefix:   util.Bech32PrefixKaspi,
				expectedPrefix: util.Bech32PrefixKaspi,
			},
			{
				name:    "testnet p2pk",
				addr:    "kaspitest:qputx94qseratdmjs0j395mq8u03er0x3l35ennsep3hxfe7ln35ckquw528z",
				encoded: "kaspitest:qputx94qseratdmjs0j395mq8u03er0x3l35ennsep3hxfe7ln35ckquw528z",
				valid:   true,
				result: util.TstAddressPubKey(
					util.Bech32PrefixKaspiTest,
					[util.PublicKeySize]byte{
				...
				f: func() (util.Address, error) {
					...
					return util.NewAddressPublicKey(publicKey, util.Bech32PrefixKaspiTest)
				},
				passedPrefix:   util.Bech32PrefixKaspiTest,
				expectedPrefix: util.Bech32PrefixKaspiTest,
			},

			// ECDSA P2PK tests.
			{
				name:    "mainnet ecdsa p2pk",
				addr:    "kaspi:qyp0r5mcq4rd5grj3652ra09u5dcgwqq9ntuswp247nama5quyj40eq03sc2dkx",
				encoded: "kaspi:qyp0r5mcq4rd5grj3652ra09u5dcgwqq9ntuswp247nama5quyj40eq03sc2dkx",
				valid:   true,
				...
				f: func() (util.Address, error) {
					...
					return util.NewAddressPublicKeyECDSA(publicKey, util.Bech32PrefixKaspi)
				},
				passedPrefix:   util.Bech32PrefixUnknown,
				expectedPrefix: util.Bech32PrefixKaspi,
			},
			...
			},
			{
				...
				addr:           "kaspi:qr35ennsep3hxfe7lnz5ee7j5jgmkjswss74as46gx",
				valid:          false,
				passedPrefix:   util.Bech32PrefixKaspi,
				expectedPrefix: util.Bech32PrefixKaspi,
			},
			...
			{
				name:    "mainnet p2sh",
				addr:    "kaspi:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdzmh8rj9f4",
				encoded: "kaspi:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdzmh8rj9f4",
				valid:   true,
				...
				f: func() (util.Address, error) {
					script := []byte{
						...
						0xae}
					return util.NewAddressScriptHash(script, util.Bech32PrefixKaspi)
				},
				passedPrefix:   util.Bech32PrefixKaspi,
				expectedPrefix: util.Bech32PrefixKaspi,
			},
			{
				name:    "mainnet p2sh 2",
				addr:    "kaspi:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxyhvsake2",
				encoded: "kaspi:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxyhvsake2",
				valid:   true,
				result: util.TstAddressScriptHash(
					util.Bech32PrefixKaspi,
					[blake2b.Size256]byte{
				...
				f: func() (util.Address, error) {
					...
					return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixKaspi)
				},
				passedPrefix:   util.Bech32PrefixKaspi,
				expectedPrefix: util.Bech32PrefixKaspi,
			},
			{
				name:    "testnet p2sh",
				addr:    "kaspitest:przhjdpv93xfygpqtckdc2zkzuzqeyj2pt5vxqxg0xrwl2zvxl5vx35yyy2h9",
				encoded: "kaspitest:przhjdpv93xfygpqtckdc2zkzuzqeyj2pt5vxqxg0xrwl2zvxl5vx35yyy2h9",
				valid:   true,
				result: util.TstAddressScriptHash(
					util.Bech32PrefixKaspiTest,
					[blake2b.Size256]byte{
				...
				f: func() (util.Address, error) {
					...
					return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixKaspiTest)
				},
				passedPrefix:   util.Bech32PrefixKaspiTest,
				expectedPrefix: util.Bech32PrefixKaspiTest,
			},
...
func TestDecodeAddressErrorConditions(t *testing.T) {
	tests := []struct {
		...
		{
			"kaspisim:raskzctpv9skzctpv9skzctpv9skzctpvy37ct7zafpv9skzctpvymmnd3gh8",
			util.Bech32PrefixKaspiSim,
			"unknown address type",
		},
		{
			"kaspisim:raskzcg58mth0an",
			util.Bech32PrefixKaspiSim,
			"unknown address type",
		},
		{
			"kaspitest:qqq65mvpxcmajeq44n2n8vfn6u9f8l4zsy0xez0tzw",
			util.Bech32PrefixKaspi,
...
func TestParsePrefix(t *testing.T) {
	tests := []struct {
		...
		{"kaspi", util.Bech32PrefixKaspi, false},
		{"kaspitest", util.Bech32PrefixKaspiTest, false},
		{"kaspisim", util.Bech32PrefixKaspiSim, false},
...
func TestPrefixToString(t *testing.T) {
	tests := []struct {
		...
		{util.Bech32PrefixKaspi, "kaspi"},
		{util.Bech32PrefixKaspiTest, "kaspitest"},
		{util.Bech32PrefixKaspiSim, "kaspisim"},
		{util.Bech32PrefixUnknown, ""},
	}
