...
// other than the base unit of a kaspi. The value of the AmountUnit
// is the exponent component of the decadic multiple to convert from
// an amount in kaspi to an amount counted in units.
type AmountUnit int

// These constants define various units used when describing a kaspi
// monetary amount.
const (
...
// Amount represents the base kaspi monetary unit (colloquially referred
// to as a `Sompi'). A single Amount is equal to 1e-8 of a kaspi.
type Amount uint64
...
// some value in kaspi. NewAmount errors if f is NaN or +-Infinity, but
// does not check that the amount is within the total amount of kaspi
...
// floating point value representing an amount of kaspi.
...
// Format formats a monetary amount counted in kaspi base units as a
...
// useful for services that build on top of kaspi (for example, calculating
