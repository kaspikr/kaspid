/*
Package txscript implements the kaspi transaction script language.

This package provides data structures and functions to parse and execute
kaspi transaction scripts.

# Script Overview

Kaspi transaction scripts are written in a stack-base, FORTH-like language.

The kaspi script language consists of a number of opcodes which fall into
...
Typical kaspi scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend kaspi.
