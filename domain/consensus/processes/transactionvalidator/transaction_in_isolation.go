...
func (v *transactionValidator) checkTransactionAmountRanges(tx *externalapi.DomainTransaction) error {
	...
	// as a sompi. One kaspi is a quantity of sompi as defined by the
	// sompiPerKaspi constant.
	...
	for _, txOut := range tx.Outputs {
		...
		// This is impossible for Kaspi, but perhaps possible if an alt increases
