...
import (
	"github.com/kaspikr/go-muhash"
	"github.com/kaspikr/kaspid/domain/consensus/model/externalapi"
	"github.com/kaspikr/kaspid/domain/consensus/utils/blockheader"
...
var genesisHash = externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
	0x51, 0x38, 0x97, 0x2c, 0xc1, 0xb8, 0x23, 0x81,
	0x24, 0x88, 0xde, 0xea, 0x09, 0xd1, 0x8c, 0xf2,
	0x8e, 0x7f, 0x24, 0xec, 0x6f, 0x0a, 0xa7, 0x54,
	0x31, 0x2e, 0xd6, 0x24, 0x98, 0xac, 0x90, 0x34,
})

// genesisMerkleRoot is the hash of the first transaction in the genesis block
// for the main network.
var genesisMerkleRoot = externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
	0x2e, 0x29, 0xf2, 0xf6, 0x21, 0x18, 0x86, 0x3b,
	0x9f, 0xf5, 0x89, 0x34, 0x60, 0x38, 0x25, 0x77,
	0x5f, 0x58, 0xec, 0x3b, 0xed, 0x02, 0xe7, 0xdc,
	0x77, 0x52, 0xf3, 0x8f, 0x1a, 0x5e, 0x8a, 0xf5,
})
...
var devnetGenesisTxPayload = []byte{
	...
	0x01,                                                                   // Varint
	0x00,                                                                   // OP-FALSE
	0x6b, 0x61, 0x73, 0x70, 0x61, 0x2d, 0x64, 0x65, 0x76, 0x6e, 0x65, 0x74, // kaspi-devnet
}
...
var simnetGenesisTxPayload = []byte{
	...
	0x01,                                                                   // Varint
	0x00,                                                                   // OP-FALSE
	0x6b, 0x61, 0x73, 0x70, 0x61, 0x2d, 0x73, 0x69, 0x6d, 0x6e, 0x65, 0x74, // kaspi-simnet
}
...
var testnetGenesisTxPayload = []byte{
	...
	0x01,                                                                         // Varint
	0x00,                                                                         // OP-FALSE
	0x6b, 0x61, 0x73, 0x70, 0x61, 0x2d, 0x74, 0x65, 0x73, 0x74, 0x6e, 0x65, 0x74, // kaspi-testnet
}
