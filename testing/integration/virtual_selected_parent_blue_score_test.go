...
func TestVirtualSelectedParentBlueScoreAndVirtualDAAScore(t *testing.T) {
	...
	response, err := kaspid.rpcClient.GetVirtualSelectedParentBlueScore()
	if err != nil {
	...
	err = kaspid.rpcClient.RegisterForVirtualSelectedParentBlueScoreChangedNotifications(
	...
	err = kaspid.rpcClient.RegisterForVirtualDaaScoreChangedNotifications(
