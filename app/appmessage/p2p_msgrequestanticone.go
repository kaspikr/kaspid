...
// MsgRequestAnticone implements the Message interface and represents a kaspi
...
// NewMsgRequestAnticone returns a new kaspi RequestPastDiff message that conforms to the
