...
// MsgDoneHeaders implements the Message interface and represents a kaspi
...
// NewMsgDoneHeaders returns a new kaspi DoneIBDBlocks message that conforms to the
// Message interface.
