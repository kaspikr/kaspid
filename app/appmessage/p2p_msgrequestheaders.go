...
// MsgRequestHeaders implements the Message interface and represents a kaspi
...
// NewMsgRequstHeaders returns a new kaspi RequestHeaders message that conforms to the
