...
// MsgIBDChainBlockLocator implements the Message interface and represents a kaspi
...
// NewMsgIBDChainBlockLocator returns a new kaspi locator message that conforms to
