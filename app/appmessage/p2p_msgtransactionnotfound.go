...
// MsgTransactionNotFound defines a kaspi TransactionNotFound message which is sent in response to
...
// NewMsgTransactionNotFound returns a new kaspi transactionsnotfound message that conforms to the
