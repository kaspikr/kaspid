...
// kaspi Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a kaspi
// Addresses message.
...
// NewMsgAddresses returns a new kaspi Addresses message that conforms to the
