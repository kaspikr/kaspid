...
// MsgRequestAddresses implements the Message interface and represents a kaspi
...
// NewMsgRequestAddresses returns a new kaspi RequestAddresses message that conforms to the
