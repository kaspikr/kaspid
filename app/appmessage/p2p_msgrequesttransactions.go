...
// MsgRequestTransactions implements the Message interface and represents a kaspi
...
// NewMsgRequestTransactions returns a new kaspi RequestTransactions message that conforms to
