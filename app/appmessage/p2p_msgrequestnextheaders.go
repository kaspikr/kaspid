...
// MsgRequestNextHeaders implements the Message interface and represents a kaspi
...
// NewMsgRequestNextHeaders returns a new kaspi RequestNextHeaders message that conforms to the
// Message interface.
