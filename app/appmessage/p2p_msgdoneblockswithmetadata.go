...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a kaspi
...
// NewMsgDoneBlocksWithTrustedData returns a new kaspi DoneBlocksWithTrustedData message that conforms to the
// Message interface.
