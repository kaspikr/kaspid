...
// MsgRequestRelayBlocks implements the Message interface and represents a kaspi
...
// NewMsgRequestRelayBlocks returns a new kaspi RequestRelayBlocks message that conforms to
