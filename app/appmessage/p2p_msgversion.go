...
var DefaultUserAgent = fmt.Sprintf("/kaspid:%s/", version.Version())

// MsgVersion implements the Message interface and represents a kaspi version
...
// NewMsgVersion returns a new kaspi version message that conforms to the
