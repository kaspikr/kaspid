...
// RPCTransaction is a kaspid transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a kaspid transaction input representation
...
// RPCScriptPublicKey is a kaspid ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a kaspid transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a kaspid outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a kaspid utxo entry representation meant to be used
// over RPC
