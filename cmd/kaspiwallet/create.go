...
import (
	...
	"github.com/kaspikr/kaspid/cmd/kaspiwallet/libkaspiwallet/bip32"
	"github.com/kaspikr/kaspid/cmd/kaspiwallet/utils"
...
func create(conf *createConfig) error {
	...
	fmt.Printf("Notice the above is neither a secret key to your wallet " +
		"(use \"kaspiwallet dump-unencrypted-data\" to see a secret seed phrase) " +
		"nor a wallet public address (use \"kaspiwallet new-address\" to create and see one)\n\n")
	...
	if len(signerExtendedPublicKeys) > 0 {
		cosignerIndex, err = libkaspiwallet.MinimumCosignerIndex(signerExtendedPublicKeys, extendedPublicKeys)
		if err != nil {
			return err
		}
	}
