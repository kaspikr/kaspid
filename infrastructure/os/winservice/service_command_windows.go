...
// installService attempts to install the kaspid service. Typically this should
...
// removeService attempts to uninstall the kaspid service. Typically this should
...
// startService attempts to Start the kaspid service.
