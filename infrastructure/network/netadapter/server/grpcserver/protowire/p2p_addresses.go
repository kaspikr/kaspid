...
func (x *KaspidMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "KaspidMessage_Addresses is nil")
	}
...
func (x *KaspidMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {
