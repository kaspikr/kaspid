...
func (x *KaspidMessage_RequestPruningPointUTXOSet) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "KaspidMessage_RequestPruningPointUTXOSet is nil")
	}
...
func (x *KaspidMessage_RequestPruningPointUTXOSet) fromAppMessage(
