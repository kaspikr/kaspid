...
type P2P_MessageStreamClient interface {
	Send(*KaspidMessage) error
	Recv() (*KaspidMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *KaspidMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*KaspidMessage, error) {
	m := new(KaspidMessage)
...
func (x *p2PMessageStreamServer) Send(m *KaspidMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*KaspidMessage, error) {
	m := new(KaspidMessage)
...
func (x *rPCMessageStreamClient) Send(m *KaspidMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*KaspidMessage, error) {
	m := new(KaspidMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *KaspidMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*KaspidMessage, error) {
	m := new(KaspidMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
