...
func (x *KaspidMessage_Version) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "KaspidMessage_Version is nil")
	}
...
func (x *KaspidMessage_Version) fromAppMessage(msgVersion *appmessage.MsgVersion) error {
