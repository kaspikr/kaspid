/*
Package addressmanager implements concurrency safe Kaspi address manager.

# Address Manager Overview

In order maintain the peer-to-peer Kaspi network, there needs to be a source
of addresses to connect to as nodes come and go. The Kaspi protocol provides
